package giuseppecanzoneri.javaspringproject.utente;
...
public class UtenteController {
	...
	@PutMapping("/{userId}")
	public Utente updateUser(@PathVariable UUID userId, @RequestBody UtenteRegistrationPayload body) throws Exception {
